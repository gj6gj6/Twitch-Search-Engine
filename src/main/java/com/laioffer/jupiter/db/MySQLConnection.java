...
public class MySQLConnection {
    ...
    public void setFavoriteItem(String userId, Item item) throws MySQLException {
        ...
        // insert userid and itemid into favorite table, maybe insert item into item table?
        ...
        // IGNORE: Avoid too much exception
        saveItem(item);
    ...
    public String verifyLogin(String userId, String password) throws MySQLException {
        ...
        try {
            PreparedStatement statement = conn.prepareStatement(sql);  //preparedstatement: convenient string format
            statement.setString(1, userId);
    ...
    public boolean addUser(User user) throws MySQLException {
        ...
        try {
            ...
            return statement.executeUpdate() == 1; // check if one line is inserted into the database
        } catch (SQLException e) {
            e.printStackTrace();
